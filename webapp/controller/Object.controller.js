...
sap.ui.define([
	...
	"use strict";
	var oThis;
	return BaseController.extend("cmpc.controller.Object", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("TiHasSet", {
					hoja: sObjectId
				});
			...
			var sServiceUrl = "/sap/opu/odata/sap/ZHAS_SERV_SRV"; // ODATA URL
			var oModel = new sap.ui.model.odata.v2.ODataModel(sServiceUrl, true);
			oModel.setUseBatch(false);
			oModel.setDefaultCountMode(sap.ui.model.odata.CountMode.None);
			//oModel.setDefaultBindingMode(sap.ui.model.BindingMode.OneWay);

			var filtercod = new sap.ui.model.Filter("HOJA", sap.ui.model.FilterOperator.EQ, sObjectId);
		...
		_onBindingChange: function () {
			...
			var oResourceBundle = this.getResourceBundle(),
				...
				sObjectId = oObject.hoja,
				sObjectName = oObject.hoja;
		...
		/**
		 *@memberOf cmpc.controller.Object
		 */
		liberar: function () {
			...
			var filterhoja = new sap.ui.model.Filter("hoja", sap.ui.model.FilterOperator.EQ, sObjectId);
		...
		onObtenerAnexo: function (oEvent) {
			...
			if (oDatos.Extension === "HTM" || oDatos.Extension === "HTML") {
				...
				if (!this.dialogNota) {
					this.dialogNota = sap.ui.xmlfragment("cmpc.view.Nota", this);
		...
		obtenerAnexos: function () {
			var aFiltros = [];
			aFiltros.push(new sap.ui.model.Filter("Hoja", sap.ui.model.FilterOperator.EQ, oThis.sObjectId));
